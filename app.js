...
const representatives = {
    ...
    { name: "Anissa Hackett", bargainingTeam: true, unit: "RN", shift: "Day", phone: "313-522-6696", email: "anissahackett@gmail.com" },
    { name: "Anna Capling", unit: "RN", shift: "Day", phone: "313-969-0482", email: "annacapling9@gmail.com" },
    { name: "Becky Smola", unit: "RN", shift: "Day", phone: "734-693-3076", email: "rebeccasmola1984@gmail.com", bargainingTeam: true},
    { name: "Bretton Buccilli", unit: "RN", shift: "Day", bargainingTeam: true, phone: "248-444-5431", email: "bretton.buccilli@gmail.com" },
    ...
    { name: "Melissa Bosman", unit: "RN", shift: "Day", bargainingTeam: true, phone: "313-204-4800", email: "Melissasbosman@gmail.com" },
    { name: "Melissa Pace", unit: "RN", shift: "Day", phone: "734-765-1278", email: "Sweetnurse9498@gmail.com" },
    { name: "Michelle Barnett", unit: "RN", shift: "Day", phone: "850-728-8746", bargainingTeam: true, email: "michelle.p.barnett@gmail.com" },
    { name: "Michella Vincent", bargainingTeam: true, shift: "Day", unit: "RN", phone: "313-585-1858", email: "michella.vincent@yahoo.com" },
  ...
  "Royal Oak": [
    ...
    { name: "Elisse Beausoleil", bargainingTeam: true, shift: "Day", unit: "RN", phone: "248-320-8035", email: "elissea@gmail.com" },
    ...
    { name: "Lori Greenlee", bargainingTeam: true, shift: "Day", unit: "RN", phone: "586-651-1266", email: "lagreenlee71@gmail.com" },
    { name: "Lynn Falloni", shift: "Night", unit: "RN", phone: "586-610-3633", email: "lynn1108@att.net" },
    { name: "Michael Browning", bargainingTeam: true, shift: "Day", unit: "RN", phone: "586-453-6755", email: "Michael.browning.rn@hotmail.com" },
    ...
    { name: "Rachel Szadyr", shift: "Day", bargainingTeam: true, unit: "RN", phone: "248-408-8946", email: "rszalocal2024@gmail.com" },
    { name: "Sarah Johnson", bargainingTeam: true, shift: "Day", unit: "RN", phone: "586-604-4432", email: "SarahLocal2024@gmail.com"},
    { name: "Sarah Lawrey", shift: "Day", unit: "RN", email: "seep_law@hotmail.com"},
    { name: "Sargon Mikho", bargainingTeam: true, shift: "Day", unit: "RN", phone: "586-567-1995", email: "s.mikho@icloud.com" },
    { name: "Sharon McCombs", shift: "Night", unit: "RN", phone: "313-530-9195", email: "Smrn714@gmail.com" },
    { name: "Steven Darvill", bargainingTeam: true, shift: "Day", unit: "NP", phone: "248-709-6473", email: "stevendarvill88@gmail.com" },
    { name: "Sue VanMaanen", shift: "Day", unit: "RN", phone: "248-320-6158", email: "svmaanen2017@outlook.com" },
  ...
  "Troy": [
    ...
    { name: "Christy Finn", bargainingTeam: true, unit: "RN", shift: "Day", phone: "586-855-1247", email: "cfinn1980@sbcglobal.net" },
    ...
    { name: "Suzi Carbone", bargainingTeam: true, unit: "RN", phone: "586-944-4520", email: "Suzi_carbone@hotmail.com" },
      ...
      if (selected === 'trigona') {
        content = `
          <div class="rep-card">
            ...
            <div class="rep-buttons">
              <a href="mailto:DTrigona@teamster.org" class="email-button">Email</a>
            </div>
          </div>`;
        ...
        content = `
          <div class="rep-card">
            ...
            <div class="rep-title highlight-blue">Teamsters Local 2024 RN Rep.</div>
            <div class="rep-title">IBT Health Care Division Representative</div>
            <div class="rep-buttons">
