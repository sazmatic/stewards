...
const representatives = {
  "Royal Oak": [
        { name: "Carol Sharp", email: "carol.sharp@example.com" },
    { name: "Christine Baker", email: "chrstnpetri@yahoo.com" },
    { name: "Christine Young", email: "christine.young@example.com" },
    { name: "Claire Steffes", email: "Claireniehaus@yahoo.com" },
    { name: "Elisse Beausoleil", email: "elissea@gmail.com" },
    { name: "Emmy Castillon", email: "emmy.castillon@example.com" },
    { name: "Jacquelyn Whitmore", email: "Jczarn01@outlook.com" },
    { name: "Jill Judkins", email: "timjudkins@comcast.net" },
    { name: "Joelle Jordan", email: "joelle.jordan@example.com" },
    { name: "John Denomy", email: "john.denomy@example.com" },
    { name: "Josh Chezick", email: "josh.chezick@example.com" },
    { name: "Judie Laverdiere", email: "Judie.laverdiere@gmail.com" },
    { name: "Judy Hayes", email: "judy.hayes@example.com" },
    { name: "Julie Hicks", email: "julie.hicks@example.com" },
    { name: "Katelyn Savage", email: "Krsavage0@gmail.com" },
    { name: "Linda Plunkett", email: "Busyrnc28@gmail.com" },
    { name: "Lindsey Dye", email: "lindsey.dye@example.com" },
