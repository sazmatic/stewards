...
const representatives = {
    ...
    { name: "Alyse Derry", unit: "RN", phone: "517-292-9183", email: "alysela.badie@gmail.com" },
    { name: "Alyson Zajac", unit: "RN", email: "alysomething@msn.com" },
    { name: "Amra Kaliman", unit: "RN", email: "amrakal5@sbcglobal.net" },
    { name: "Anissa Hackett", unit: "RN", phone: "313-522-6696", email: "anissahackett@gmail.com" },
    { name: "Anna Capling", unit: "RN", email: "annajosuma@ymail.com" },
  ...
  "Royal Oak": [
    ...
    { name: "Julie Hicks", phone: "248-840-0325", unit: "RN", email: "Juliemhicks123@yahoo.com" },
    ...
    { name: "Michael Brown", shift: "Day", unit: "RN", phone: "586-453-6755", email: "Michael.browning.rn@hotmail.com" },
  ...
  "Troy": [
    ...
    { name: "Ashley Kraft", unit: "RN", email: "ashbroski@gmail.com" },
    { name: "Barb Douglas", unit: "RN", phone: "248-565-6594", email: "bdouglas78@icloud.com" },
    { name: "Brenda Tesnar", unit: "RN", shift: "Night", phone: "248-895-5738", email: "Beetesnar71@gmail.com" },
    { name: "Christy Finn", unit: "RN", phone: "586-855-1247", email: "cfinn1980@sbcglobal.net" },
    { name: "Devon Timmerman", unit: "RN", email: "timmerman.nursing@gmail.com" },
    { name: "Donna Bazinski", unit: "RN", email: "dmbazinski@yahoo.com" },
    { name: "Doreen Gwinn", unit: "RN", email: "gwinns2000@gmail.com" },
    { name: "Eileen Blodgett", unit: "RN", email: "eblodg312@icloud.com" },
    { name: "Eric Frazer", unit: "RN", email: "Efrazer329@yahoo.com" },
    { name: "Ethan Tolentino", unit: "RN", email: "will.tolentino@corewellhealth.org" },
    { name: "Jacob Allen", unit: "RN", email: "acobgallen1992@gmail.com" },
  ...
  "Grosse Pointe": [
    ...
    { name: "Samantha Parisi", unit: "RN", phone: "586-322-4085", site: "Lenox", title: "<em>Lenox Campus</em>", email: "samantharn92@gmail.com" },
    { name: "Stephanie Brooks", unit: "RN", site: "Lenox", email: "sbrooks827@yahoo.com" }
  ],
  "Wayne": [
    ...
    { name: "Lisa Rich", unit: "RN", email: "l.rich3@yahoo.com" },
    { name: "Mandy O’Rourke", unit: "RN", email: "morourke516@yahoo.com" },
    { name: "Natalie Lunsford", unit: "RN", phone: "734-250-4073", email: "natrn91@wowway.com" },
  ...
  "Taylor": [
    { name: "Allison Lorentz", unit: "RN", phone: "734-718-5366", email: "jrsice1@gmail.com" },
    { name: "Brittany DeJohn", unit: "RN", email: "brittanydejon610@gmail.com" },
    { name: "Heather Vorhoff", unit: "RN", email: "Heather.vorhoff@yahoo.com" },
    { name: "Kate Seidel", unit: "RN", email: "kwainman@aol.com" },
    { name: "Michelle Wood", unit: "NP", email: "mpwood.mpw@gmail.com" },
    { name: "Mike Gumbis", unit: "RN", email: "Mlgumbis02@yahoo.com" },
    { name: "Nancy Sannno", unit: "RN", email: "Nsanno1@yahoo.com" },
    { name: "Tavena Dysart", unit: "RN", email: "Tavena_dysart@yahoo.com" },
  ],
  "Trenton": [
    ...
    { name: "Thomas Bellman", unit: "RN", email: "tbellman411@hotmail.com" },
  ]
};
  ...
  .map(rep => `
    <div class="rep-card">
      <div class="badge-wrapper">
        ${rep.unit ? `
          <div class="unit-badge ${rep.unit.toUpperCase() === 'NP' ? 'np' : 'rn'}">
