...
const representatives = {
  "Royal Oak": [
    { name: "Carol Sharp", title: "RN, Med/Surg", email: "carol.sharp@example.com" },
    { name: "Christine Baker", title: "RN, FBC", email: "chrstnpetri@yahoo.com" },
    { name: "Christine Young", title: "RN, FBC", email: "christine.young@example.com" },
    { name: "Claire Steffes", title: "RN, FBC", email: "Claireniehaus@yahoo.com" },
    { name: "Elisse Beausoleil", title: "RN, Emergency", email: "elissea@gmail.com" },
    { name: "Emmy Castillon", title: "RN, CCS", email: "emmy.castillon@example.com" },
    { name: "Jacquelyn Whitmore", title: "RN, Cath Lab", email: "Jczarn01@outlook.com" },
    { name: "Jill Judkins", title: "RN, Med/Surg", email: "timjudkins@comcast.net" },
    { name: "Joelle Jordan", title: "RN, OR", email: "joelle.jordan@example.com" },
    { name: "John Denomy", title: "RN, PCU", email: "john.denomy@example.com" },
    { name: "Josh Chezick", title: "RN, PCU", email: "josh.chezick@example.com" },
    { name: "Judie Laverdiere", title: "RN, Surgical Services", email: "Judie.laverdiere@gmail.com" },
    { name: "Judy Hayes", title: "RN, PACU", email: "judy.hayes@example.com" },
    { name: "Julie Hicks", title: "RN, GYN", email: "julie.hicks@example.com" },
    { name: "Katelyn Savage", title: "RN, ICU", email: "Krsavage0@gmail.com" },
    { name: "Linda Plunkett", title: "RN, CCS", email: "Busyrnc28@gmail.com" },
    { name: "Lindsey Dye", title: "RN, Pediatrics", email: "lindsey.dye@example.com" },
    { name: "Lori Greenlee", title: "RN, FBC", phone: "586-651-1266", email: "lagreenlee71@gmail.com" },
    { name: "Michael Brown", title: "RN, Cath Lab", email: "Michael.browning.rn@hotmail.com" },
    { name: "Michelle Dewilde", title: "RN, FBC", email: "michelledewilde@yahoo.com" },
    { name: "Natalie Richmond", title: "RN, PCU", email: "littlemissrichmond@gmail.com" },
    { name: "Rachael Patton", title: "RN, MBU", email: "Rachael.patton@icloud.com" },
    { name: "Rachel Szadyr", title: "RN, ICU", email: "szadyrr@gmail.com" },
    { name: "Sarah Johnson", title: "RN, Royal Oak", phone: "586-604-4432", email: "sarah.johnson7170@gmail.com"},
    { name: "Sargon Mikho", title: "RN, PCU", phone: "586-567-1995", email: "s.mikho@icloud.com" },
    { name: "Sharon McCombs", title: "RN, PACU", email: "Smrn714@gmail.com" },
    { name: "Stephanie Leneway", title: "RN, PACU", email: "Stephann3@mac.com" },
    { name: "William Lootens", title: "RN, Emergency", email: "billyonair@aol.com" },
    { name: "Yvonne Marchesseault", title: "RN, Rad. Onc.", email: "Fifimarch@yahoo.com" },
    { name: "Zak Shugart", title: "RN, WOC", email: "Zak.shugart@gmail.com" },
  ],
  "Troy": [
