...
const representatives = {
  ...
  "Royal Oak": [
    ...
    { name: "Elisse Beausoleil", shift: "Day", phone: "248-320-8035", email: "elissea@gmail.com" },
    { name: "Emily Bogart", shift: "Day", title: "Nurse Practitioner", email: "embogart@gmail.com" },
    { name: "Emmy Castillon", shift: "Day", email: "Emmylynncoronel@gmail.com" },
    ...
    { name: "Lori Greenlee", shift: "Day", phone: "586-651-1266", email: "lagreenlee71@gmail.com" },
    { name: "Michael Brown", shift: "Day", email: "Michael.browning.rn@hotmail.com" },
    { name: "Michelle Dewilde", shift: "Day", phone: "810-938-3138", email: "michelledewilde@yahoo.com" },
    { name: "Natalie Richmond", shift: "Day", phone: "248-873-7373", email: "littlemissrichmond@gmail.com" },
    { name: "Rachael Patton", shift: "Day", email: "Rachael.patton@icloud.com" },
    { name: "Rachel Szadyr", shift: "Day", phone: "248-408-8946", email: "szadyrr@gmail.com" },
    { name: "Sarah Johnson", shift: "Day", phone: "586-604-4432", email: "sarah.johnson7170@gmail.com"},
    { name: "Sargon Mikho", shift: "Day", phone: "586-567-1995", email: "s.mikho@icloud.com" },
    { name: "Sharon McCombs", shift: "Night", phone: "313-530-9195", email: "Smrn714@gmail.com" },
    { name: "Stephanie Leneway", shift: "Day", email: "Stephann3@mac.com" },
...
repName.innerHTML = representatives[campus]
  .map(rep => `
    <div class="rep-card">
      ${rep.shift === 'Day' ? `<div class="shift-badge" title="Day Shift">☀️</div>` : ''}
${rep.shift === 'Night' ? `<div class="shift-badge" title="Night Shift">🌙</div>` : ''}
      <div class="rep-name">
